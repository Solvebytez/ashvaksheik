...
const staticRoutes: MetadataRoute.Sitemap = [
  ...
  { url: `${SITE_URL}/trusted-realtor-gta`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
  { url: `${SITE_URL}/first-time-home-buyer-realtor`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
  { url: `${SITE_URL}/investment-property-realtor`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
  ...
  { url: `${SITE_URL}/richmond-hill-realtor`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
