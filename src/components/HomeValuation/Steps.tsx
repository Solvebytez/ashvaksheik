  ...
  return (
    ...
    <li className="shrink basis-0 flex-1 group">
      <div className="min-w-12 min-h-12 w-full inline-flex items-center text-xs align-middle">
        <span className={`size-8 md:size-12 flex justify-center items-center shrink-0 bg-white font-bold text-gray-800 rounded-full text-base md:text-xl`}>
          1
        </span>
    ...
    <li className="shrink basis-0 flex-1 group">
      <div className="min-w-7 min-h-7 w-full inline-flex items-center text-xs align-middle">
        <span className={`size-8 md:size-12 flex justify-center items-center shrink-0  bg-white font-bold  rounded-full text-base md:text-xl ${currentStep === STEPS.MAIN_FORM || currentStep === STEPS.LAST_MESSAGE?'bg-opacity-100 text-black':'bg-opacity-15 text-white'}`}>
          2
        </span>
    ...
    <li className="shrink basis-0 flex-0 group">
      <div className="min-w-7 min-h-7 w-full inline-flex items-center text-xs align-middle">
      <span className={`size-8 md:size-12 flex justify-center items-center shrink-0  bg-white font-bold  rounded-full text-base md:text-xl ${currentStep === STEPS.LAST_MESSAGE?'bg-opacity-100 text-black':'bg-opacity-15 text-white'}`}>
          3
        </span>
