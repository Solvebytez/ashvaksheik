...
const ContactModal = ({prijectName}:{prijectName:string}) => {
  ...
  return (
    <div className="text-white flex items-start justify-center p-4">
      {!isShowForm ? (
        <div className="md:max-w-6xl w-full grid grid-cols-1 md:grid-cols-12 gap-16 py-12">
          ...
          <div className="col-span-6 px-3 md:px-11 modalForm relative">
            <h1 className="text-4xl font-tenor_Sans tracking-[4px] mb-4 pt-16 lg:pt-0 text-center">
              SUBMIT A MESSAGE
            </h1>
            <form
