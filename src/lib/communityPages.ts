...
export const communityPages: CommunityPage[] = [
  {
    ...
    keywords: [
      ...
      "Telugu speaking realtor Ontario",
      "Telugu real estate agent Canada",
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. Ashvak Sheik works from Brampton and regularly helps clients in Mississauga, Caledon, and the west GTA. You can speak with him in Telugu or English.",
      },
    ],
  },
  {
    path: "/hyderabadi-realtor",
    ...
    keywords: [
      ...
      "Hyderabadi realtor Canada",
      "Hyderabadi realtor Mississauga",
      "Hyderabadi realtor Brampton",
      "Hyderabad realtor GTA",
      "Deccan realtor Ontario",
    ],
  ...
  {
    path: "/desi-realtor",
    title: "Indian and Desi Realtor in the GTA",
    banner: "Desi Realtor",
    description:
      "Ashvak Sheik is an Indian / Desi / South Asian realtor in the GTA. Telugu-speaking Hyderabadi realtor helping South Asian buyers and sellers in Toronto and Brampton.",
    keywords: [
      "Indian realtor GTA",
      "Indian realtor Toronto",
      "Desi realtor Brampton",
      "South Asian realtor Ontario",
      "South Indian realtor Toronto",
      "Indian real estate agent Canada",
      "Desi realtor Mississauga",
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Ashvak Sheik is a South Indian, Telugu-speaking realtor serving Toronto and the GTA. Contact 647-890-0982 or ashvak.realtor07@gmail.com.",
      },
    ],
  },
  {
...
export function getCommunityPage(path: string) {
  return communityPages.find((page) => page.path === path);
}
